...
@endforeach
     ...
     <div class="row no-print mt-4">
        <div class="col-md-12 text-center">
            <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#yourModal">View</button>
                        ...
                        <div class="card-body invoice-head">
                            <div class="row d-flex align-items-center justify-content-between">
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <img src="{{ URL::asset('assets/images/logo-sm.png') }}" alt="logo-small" class="logo-sm mr-3" height="30">
                                    <div>
                        ...
                        <div class="card-body">
                            <div class="row d-flex align-items-center flex-nowrap">
                                ...
                                <div class="col-md-4 text-left">
                                    <h6 class="m-0"><b>Invoice No :</b> #{{$receiptId ?? 'N/A'}}</h6>
