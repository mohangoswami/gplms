...
<head>
<meta charset="utf-8">
<title>BULK REPORT CARDS – CLASS {{ strtoupper($grade) }}</title>
...
// Term IDs are constant across all students – resolve once
...
@php
    ...
    // ── DYNAMIC MAX MARKS (computed BEFORE merge so values stay per-subject) ──
...
<tr>
    <th>AREA</th>
    @foreach($terms as $t)<th>{{ strtoupper($t->name) }}</th>@endforeach
</tr>
