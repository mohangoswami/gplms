...
.signature-table td{border:none;padding:2px 4px;line-height:1.1;text-align:center;vertical-align:bottom;}
/* DomPDF fix: use block instead of inline-block */
.signature-line{display:block;width:120px;border-top:1px solid #000;margin-top:30px;}
.instructions{text-align:center;font-size:10.5px;margin-top:10px;}
.grade-table{width:50%;margin-top:6px;font-size:10.5px;}
...
{{-- ================= SCHOLASTIC ================= --}}
@php
    $term1Id       = $terms->get(0)?->id;
    $term2Id       = $terms->get(1)?->id;
