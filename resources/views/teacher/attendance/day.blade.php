...
<div class="container mt-4">
    ...
    <div class="card mt-3">
        <div class="card-body">
            <div class="mb-3">
                <a href="{{ route('teacher.attendance.view') }}" class="btn btn-secondary">Back</a>
                <a href="{{ route('teacher.attendance.month', ['class' => $class, 'year' => \Carbon\Carbon::parse($date)->year, 'month' => \Carbon\Carbon::parse($date)->month]) }}" class="btn btn-outline-primary">View Month</a>
            </div>
