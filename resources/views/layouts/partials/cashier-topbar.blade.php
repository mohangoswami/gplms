                ...
                <ul class="list-unstyled topbar-nav float-right mb-0">
                    ...
                    <li class="dropdown">
                        ...
                        <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                            aria-haspopup="false" aria-expanded="false">
                            <span class="ml-1 nav-user-name hidden-sm">{{ Auth::guard('cashier')->user()->name }} <i class="mdi mdi-chevron-down"></i> </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                         <!--   <a class="dropdown-item" href="#"><i class="dripicons-user text-muted mr-2"></i> Profile</a>
                            ...
                            <a class="dropdown-item" href="/cashier/cashier-update-password">
                            ...
                            <a class="dropdown-item" href="{{ route('logout') }}"
                                ...
                                <form id="logout-form" action="{{ url('/cashier/logout') }}" method="POST" class="d-none">
                                    @csrf
                                </form>
