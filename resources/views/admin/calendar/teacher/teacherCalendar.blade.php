...
@section('title', 'Student Attendance Record')
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                             ...
                             @component('common-components.breadcrumb')
                                 ...
                                 @slot('item1')<a href="/home"> Home </a>@endslot
                                 @slot('item2') Calendar @endslot
                              @endcomponent
                              <button onclick="window.location.href='/admin/teacher/teachersAttendance'" class="btn btn-gradient-primary px-4 mt-0 mb-3">Back</button>
