                        ...
                        <table id="table1" class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/fee/printReceipt/{{$receipt->receiptId}}" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Print" data-trigger="hover"><i class="fas fa-print text-info font-16"></i></a>
                                    <a onclick="return confirm('Are you sure want to delete?')" href="/fee/deleteFeeReceipt/{{$receipt->receiptId}}/{{$user->id}}"><i class="fas fa-trash-alt text-danger font-16"></i></a>
                                </td>
                            </tr>
