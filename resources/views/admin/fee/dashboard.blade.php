 ...
 <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                               ...
                               @component('common-components.breadcrumb')
                                 ...
                                 @slot('item1') Fee @endslot
                                 @slot('item2') Fee @endslot
                              @endcomponent
                            ...
                            <div class="card report-card">
                                <div class="card-body">
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-8">
                                            <p class="text-dark font-weight-semibold font-14">Fee Collection</p>
                                            <h3 class="my-3">Deposit</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title mt-0">Fee Details</h4>
                                    <div class="">
...
<script>
    window.feeMonths   = @json($feeMonths);
    window.feeReceived = @json($feeReceived);
    window.feeBalance  = @json($feeBalance);
</script>
<script src="{{ asset('js/jquery.analytics_dashboard.init.js') }}"></script>
